...
<div class="offers">
    <div class="offers__title">
        ...
        <div class="offers__box">
            <h4>Home<strong> | </strong><span>Offers</span></h4>
        </div>
    </div>
        ...
        <div class="offers-room">
            <div class="offers-img">
                ...
                <div>
                    ...
                    <p class="offers-price">$345<span>/Night</span></p>
                </div>
            </div>
            ...
            <p class="offers-text">
                ...
                reprehend erit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </p>

            <div class="offers-list">
                <div>
                    <div class="items">
                        <img src="src/img/rooms/air.svg" alt="air">
                        <p>Air conditioner </p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/bf.svg" alt="Breakfast">
                        <p>Breakfast</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/clean.svg" alt="Cleaning">
                        <p>Cleaning</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/grocery.svg" alt="Grocery">
                        <p>Grocery</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/shop.svg" alt="Shop">
                        <p>Shop near</p>
                    </div>
                </div>
                ...
                <div>
                    <div class="items">
                        <img src="src/img/rooms/wifi.svg" alt="wifi">
                        <p>High speed WiFi</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/cook.svg" alt="Kitchen">
                        <p>Kitchen</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/shower.svg" alt="Shower">
                        <p>Shower</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/bed.svg" alt="bed">
                        <p>Single bed</p>
                    </div>

                    <div class="items">
                        <img src="src/img/rooms/towel.svg" alt="Towels">
                        <p>Towels</p>
                    </div>
                </div>
            </div>
